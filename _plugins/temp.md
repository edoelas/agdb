...
![Wireframe sketch showing problems.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/sketch_problems.png)*Wireframe sketch with problems.*
...
![Test showing multiple contrast ratios.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/contrast_test.png)*Test showing multiple contrast ratios.*
...
![Example showing where to use high contrast colours. The second column has an achromatopsia filter.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/ui_test.png)*Example showing where to use high contrast colours. The second column has an achromatopsia filter.* 
...
![Example showing two teams, green and red, over brown background. The second image has a deuteronopia filter.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/teams_test2.png)*Example showing two teams, green and red, over brown background. The second image has a deuteronopia filter.*
...
![Image showing simulations of the different problems related to colour perception.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/color_blind_types.png)*Image showing simulations of the different problems related to colour perception.*
...
![The palette proposed by Masataka Okabe and Kei Ito: #E60F00, #56B4E9, #009E73, #F0E442, #0072B2, #D55E00, #CC79A7, #000000 .](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/okabe-ito.png)*The palette proposed by Masataka Okabe and Kei Ito: #E60F00, #56B4E9, #009E73, #F0E442, #0072B2, #D55E00, #CC79A7, #000000 .*

![One palette proposed by Paul Tol: #4477AA, #66CCEE, #228833, #CCBB44, #EE6677, #AA3377, #BBBBBB .](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/tol.png)*One of the palettes proposed by Paul Tol: #4477AA, #66CCEE, #228833, #CCBB44, #EE6677, #AA3377, #BBBBBB .*
...
![Example of the accesibility features of Hue.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/hue_game.jpg)*Example of the accesibility features of Hue.*

![Example of the accesibility features of Chroma Gun.](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/chroma_gun.png)*Example of the accesibility features of Chroma Gun.*
...
![Changes of the textures of Minecraft's ores. Image obtained from [Isk Mogul](https://www.iskmogul.com/minecraft-is-adding-new-ore-textures-for-a-very-good-reason/).](/agdb/assets/media/2021-06-06-About-easy-to-implement-accesibility/minecraft.jpg)*Changes of the textures of Minecraft's ores. Image obtained from [Isk Mogul](https://www.iskmogul.com/minecraft-is-adding-new-ore-textures-for-a-very-good-reason/).*
